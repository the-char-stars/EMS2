/**
 * \file PatientsCommand.cs
*  \project INFO2180 - EMS System Term Project
*  \author The Char Stars - Tudor Lupu
*  \date 2018-12-4
*  \brief The main menu of the Patients
*  
*  This class serves as only the main Patients menu.
...
namespace EMS_Client.MenuOptions
{
    ...
    */
    class PatientsCommand : IOption
    {
        #region public fields
        public string Description => "Patients";
        #endregion
